...
<p>Evidence-led product, game, and methodology teardown for actionable transfer.</p>
...
```text
帮我安装 product-teardown：https://raw.githubusercontent.com/Fable-Forge/product-teardown/main/docs/install.md
```
...
- 成熟度：`beta`
- GitHub Topics：`product-teardown`, `competitive-analysis`, `game-analysis`, `strategy`
...
- 🐛 Bug 与功能建议：[product-teardown Issues](https://github.com/Fable-Forge/product-teardown/issues)
