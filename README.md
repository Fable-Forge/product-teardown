...
```text
Install product-teardown: https://raw.githubusercontent.com/Fable-Forge/product-teardown/main/docs/install.md
```
...
- 🐛 Bugs and feature requests: [product-teardown Issues](https://github.com/Fable-Forge/product-teardown/issues)
